...
import { StickyNote, ImageIcon, Type, MousePointer2, Hand, Trash2, Save, Sun, Moon } from 'lucide-react';
...
export function Toolbar({ onAddNote, onAddImage, onAddHeader, onSave }: ToolbarProps) {
  const { activeTool, setActiveTool, isSaving, theme, setTheme } = useEditorStore();
